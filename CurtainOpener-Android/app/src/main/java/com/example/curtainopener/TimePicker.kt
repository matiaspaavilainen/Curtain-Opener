...
fun TimeDialog(
    ...
    val daysToChange: MutableList<String> = mutableListOf()
...
fun DropDown(currentDay: String, daysToChange: MutableList<String>) {
    ...
    val daysToChangeList: List<List<String>> = listOf(
        listOf(currentDay),
        listOf<String>("Monday", "Tuesday", "Wednesday", "Thursday", "Sunday"),
        listOf<String>("Friday", "Saturday"),
